...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'images_image', 'date_uploaded',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'images_image', 'date_uploaded')
    ...
    models = {
        ...
        u'images.image': {
            'Meta': {'ordering': "['-date_uploaded']", 'object_name': 'Image'},
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uploader': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Account']"})
        }
    }
